...
public class SequentialXorFunctions {
  ...
  public static <X> FormattedNamedFunction<X, Double> avgScore(
      ...
      @Param(value = "of", dNPM = "f.identity()") Function<X, Simulation.Outcome<SequentialXor.Step>> beforeF,
    ...
    Function<Simulation.Outcome<SequentialXor.Step>, Double> f = o -> {
      List<SequentialXor.Step> stepList = o.snapshots()
          .values()
          .stream()
          .toList();
  ...
  public static <X> FormattedNamedFunction<X, Double> avgScoreDelta(
    ...
    Function<Simulation.Outcome<SequentialXor.Step>, Double> f = o -> o.snapshots()
        .values()
        .stream()
        .collect(Collectors.groupingBy(SequentialXor.Step::stringInputs))
        .values()
        .stream()
        .mapToDouble(steps -> {
